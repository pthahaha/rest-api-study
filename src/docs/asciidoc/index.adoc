...
operation::get-an-event[snippets='response-fields,curl-request,http-response,links']
...
operation::update-event[snippets='request-headers,request-fields,curl-request,http-response,links']